...
public abstract class AbstractContext extends JFrame implements DrawContext {
	...
	private List<DrawToolFactory> toolFactories = new LinkedList<DrawToolFactory>();
	...
	private Map<AbstractButton, DrawTool> tools = new HashMap<AbstractButton, DrawTool>();
	...
	private Set<AWTKeyStroke> keystrokes = new HashSet<AWTKeyStroke>();
	{
